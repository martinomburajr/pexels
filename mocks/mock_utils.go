...
// Source: github.com/martinomburajr/pexels/utils (interfaces: BackgroundChanger,Filer,Rander,Utilizer,HTTPRequester)
...
func (m *MockUtilizer) ParseRequest(arg0, arg1 string) ([]byte, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ParseRequest", arg0, arg1)
	ret0, _ := ret[0].([]byte)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockUtilizerMockRecorder) ParseRequest(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ParseRequest", reflect.TypeOf((*MockUtilizer)(nil).ParseRequest), arg0, arg1)
}
...
// ParseRequest mocks base method
func (m *MockHTTPRequester) ParseRequest(arg0, arg1 string) ([]byte, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ParseRequest", arg0, arg1)
	ret0, _ := ret[0].([]byte)
	ret1, _ := ret[1].(error)
...
// ParseRequest indicates an expected call of ParseRequest
func (mr *MockHTTPRequesterMockRecorder) ParseRequest(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ParseRequest", reflect.TypeOf((*MockHTTPRequester)(nil).ParseRequest), arg0, arg1)
}
